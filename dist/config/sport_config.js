...
exports.SPORT_CONFIGS = void 0;
exports.getSportConfig = getSportConfig;
exports.getEnabledSports = getEnabledSports;
exports.SPORT_CONFIGS = {
    NBA: {
        sgoLeagueId: "NBA",
...
function getSportConfig(sport) {
    return exports.SPORT_CONFIGS[sport];
}
function getEnabledSports(sports) {
