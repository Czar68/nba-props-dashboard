...
exports.UNDERDOG_STRUCTURE_THRESHOLDS = exports.UNDERDOG_MAX_ATTEMPTS_FRACTION_OF_GLOBAL = exports.UNDERDOG_BASE_ATTEMPTS_PER_CARD = exports.UNDERDOG_TARGET_ACCEPTED_CARDS = exports.UNDERDOG_GLOBAL_LEG_EV_FLOOR = exports.UNDERDOG_STRUCTURE_IDS = exports.ALL_UNDERDOG_STRUCTURES = exports.UNDERDOG_FLEX_STRUCTURES = exports.UNDERDOG_STANDARD_STRUCTURES = void 0;
exports.getUnderdogStructureById = getUnderdogStructureById;
exports.getUnderdogStructuresBySize = getUnderdogStructuresBySize;
exports.getUnderdogStructuresByType = getUnderdogStructuresByType;
exports.getUnderdogStructureId = getUnderdogStructureId;
exports.isValidUnderdogStructure = isValidUnderdogStructure;
exports.calculateBreakEvenLegWinRate = calculateBreakEvenLegWinRate;
exports.getUnderdogStructureThreshold = getUnderdogStructureThreshold;
exports.meetsUnderdogLegEvFloor = meetsUnderdogLegEvFloor;
exports.meetsUnderdogStructureThreshold = meetsUnderdogStructureThreshold;
exports.canLegsMeetStructureThreshold = canLegsMeetStructureThreshold;
exports.getUnderdogMaxAttemptsForStructure = getUnderdogMaxAttemptsForStructure;
exports.createUnderdogStructureMetrics = createUnderdogStructureMetrics;
exports.logUnderdogStructureMetrics = logUnderdogStructureMetrics;
/**
...
exports.UNDERDOG_STANDARD_STRUCTURES = [
    {
        id: 'UD_2P_STD',
        size: 2,
        type: 'standard',
...
exports.UNDERDOG_FLEX_STRUCTURES = [
    {
        id: 'UD_3F_FLX',
        size: 3,
        type: 'flex',
...
exports.ALL_UNDERDOG_STRUCTURES = [
    ...exports.UNDERDOG_STANDARD_STRUCTURES,
    ...exports.UNDERDOG_FLEX_STRUCTURES,
];
// Helper functions for structure lookup
function getUnderdogStructureById(id) {
    return exports.ALL_UNDERDOG_STRUCTURES.find(structure => structure.id === id);
}
function getUnderdogStructuresBySize(size) {
    return exports.ALL_UNDERDOG_STRUCTURES.filter(structure => structure.size === size);
}
function getUnderdogStructuresByType(type) {
    return exports.ALL_UNDERDOG_STRUCTURES.filter(structure => structure.type === type);
}
function getUnderdogStructureId(size, type) {
...
function isValidUnderdogStructure(id) {
...
function calculateBreakEvenLegWinRate(structure) {
...
exports.UNDERDOG_STRUCTURE_IDS = {
    // Standard (all-or-nothing)
    UD_2P_STD: 'UD_2P_STD',
    UD_3P_STD: 'UD_3P_STD',
    UD_4P_STD: 'UD_4P_STD',
 ...
 */
exports.UNDERDOG_GLOBAL_LEG_EV_FLOOR = 0.02; // Relaxed from 3% to 2% minimum leg EV
/**
 * Underdog attempt budgeting configuration
 * Controls how many attempts each structure type gets
 */
exports.UNDERDOG_TARGET_ACCEPTED_CARDS = {
    standard: 8, // Standard structures — moderate target
    flex: 6, // Flex structures — slightly conservative (ladders reduce variance)
};
exports.UNDERDOG_BASE_ATTEMPTS_PER_CARD = 20; // Attempts per target accepted card
exports.UNDERDOG_MAX_ATTEMPTS_FRACTION_OF_GLOBAL = 0.35; // Max 35% of global attempts per structure
exports.UNDERDOG_STRUCTURE_THRESHOLDS = {
 ...
 */
function getUnderdogStructureThreshold(structureId) {
    return exports.UNDERDOG_STRUCTURE_THRESHOLDS[structureId] || { minCardEv: 0.02 }; // Default fallback
}
/**
 * Check if a leg meets Underdog's global EV floor
 */
function meetsUnderdogLegEvFloor(legEv) {
    return legEv >= exports.UNDERDOG_GLOBAL_LEG_EV_FLOOR;
}
/**
 * Check if a card EV meets the structure's minimum threshold
 */
function meetsUnderdogStructureThreshold(structureId, cardEv) {
 ...
 */
function canLegsMeetStructureThreshold(structureId, legEvs, structure) {
    const threshold = getUnderdogStructureThreshold(structureId);
...
function getUnderdogMaxAttemptsForStructure(params) {
    ...
    const desiredAttempts = targetAcceptedCards * exports.UNDERDOG_BASE_ATTEMPTS_PER_CARD;
    // Compute maximum allowed per structure
    const maxPerStructure = Math.floor(exports.UNDERDOG_MAX_ATTEMPTS_FRACTION_OF_GLOBAL * globalMaxAttempts);
    // Return the minimum of all constraints, coerced to integer >= 0
    const maxAttempts = Math.min(combinatorialCeiling, desiredAttempts, maxPerStructure);
 ...
 */
function createUnderdogStructureMetrics(structureId) {
    return {
        structureId,
        attemptsAllocated: 0,
        attemptsUsed: 0,
 ...
 */
function logUnderdogStructureMetrics(metrics) {
    console.log(`${metrics.structureId}: attempts ${metrics.attemptsUsed}/${metrics.attemptsAllocated}, ` +
