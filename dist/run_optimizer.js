...
async function run() {
    ...
    let filtered = withEv.filter((leg) => leg.edge >= MIN_EDGE_PER_LEG);
    ...
    console.log(`Filtered legs: ${filtered.length} from ${withEv.length} with edge >= ${MIN_EDGE_PER_LEG}`);
