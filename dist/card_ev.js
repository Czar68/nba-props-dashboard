 ...
 */
function computeWinProbs(flexType, picks, avgProb) {
 ...
 */
async function evaluateFlexCard(flexType, legs, stake = 1) {
    ...
    const structureEV = await (0, engine_interface_1.getStructureEV)(flexType, roundedAvgProb);
    ...
    const hitDistribution = (0, kelly_mean_variance_1.computePrizePicksHitDistribution)(legs, flexType);
    const kellyResult = (0, kelly_mean_variance_1.computeKellyForCard)(structureEV.ev, hitDistribution, flexType, 'prizepicks', kelly_mean_variance_1.DEFAULT_KELLY_CONFIG);
