...
exports.resetPerformanceCounters = resetPerformanceCounters;
exports.isEvEngineDegraded = isEvEngineDegraded;
exports.resetDegradedMode = resetDegradedMode;
exports.logPerformanceMetrics = logPerformanceMetrics;
exports.getFlexEvCacheStats = getFlexEvCacheStats;
exports.getStructureEVs = getStructureEVs;
exports.finalizePendingEVRequests = finalizePendingEVRequests;
exports.getStructureEV = getStructureEV;
const googleapis_1 = require("googleapis");
// Cache for EV results to avoid duplicate API calls
const evCache = new Map();
// Track recent avgProb values for batch processing
const pendingAvgProbs = new Set();
 ...
 */
async function writeWithRetry(sheets, spreadsheetId, range, values, maxRetries = 4) {
 ...
 */
async function batchProcessAvgProbs(sheets, spreadsheetId, avgProbs) {
...
const STRUCTURE_CONFIG = [
    { structure: "2P", picks: 2, type: "Power", evCell: "Engine!B64", roiCell: "Engine!B65" },
    { structure: "3P", picks: 3, type: "Power", evCell: "Engine!B75", roiCell: "Engine!B76" },
    { structure: "3F", picks: 3, type: "Flex", evCell: "Engine!B85", roiCell: "Engine!B86" },
    { structure: "4P", picks: 4, type: "Power", evCell: "Engine!B96", roiCell: "Engine!B97" },
    { structure: "4F", picks: 4, type: "Flex", evCell: "Engine!B106", roiCell: "Engine!B107" },
    { structure: "5P", picks: 5, type: "Power", evCell: "Engine!B117", roiCell: "Engine!B118" },
    { structure: "5F", picks: 5, type: "Flex", evCell: "Engine!B127", roiCell: "Engine!B128" },
    { structure: "6P", picks: 6, type: "Power", evCell: "Engine!B138", roiCell: "Engine!B139" },
    { structure: "6F", picks: 6, type: "Flex", evCell: "Engine!B149", roiCell: "Engine!B150" },
];
...
function computeLocalStructureEVs(avgProb) {
 ...
 */
async function getStructureEVs(avgProb) {
 ...
 */
async function finalizePendingEVRequests() {
    if (pendingAvgProbs.size > 0) {
 ...
 */
async function getStructureEV(flexType, avgProb) {
