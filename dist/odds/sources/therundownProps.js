...
function getBookWeight(affiliateId) {
...
async function fetchSportPlayerPropsV2(sport, sportId, marketIds, apiKey) {
...
function processTheRundownV2Response(sport, events) {
    const results = [];
