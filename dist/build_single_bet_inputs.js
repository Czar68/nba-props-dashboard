...
exports.buildSingleBetInputsFromOddsFeed = buildSingleBetInputsFromOddsFeed;
exports.buildOddsFeedMarketsFromExistingData = buildOddsFeedMarketsFromExistingData;
exports.createTestMarkets = createTestMarkets;
const odds_math_1 = require("./odds_math");
function buildSingleBetInputsFromOddsFeed(markets) {
    return markets
        .filter(market => {
...
function buildOddsFeedMarketsFromExistingData(sgoMarkets) {
    const markets = [];
    for (const sgoMarket of sgoMarkets) {
        ...
        const overProbVigged = (0, odds_math_1.americanToProb)(sgoMarket.overOdds);
        const underProbVigged = (0, odds_math_1.americanToProb)(sgoMarket.underOdds);
