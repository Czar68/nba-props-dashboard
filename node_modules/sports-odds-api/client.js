...
var _SportsGameOdds_instances, _a, _SportsGameOdds_encoder, _SportsGameOdds_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SportsGameOdds = void 0;
...
const leagues_1 = require("./resources/leagues.js");
const players_1 = require("./resources/players.js");
const sports_1 = require("./resources/sports.js");
const stats_1 = require("./resources/stats.js");
const stream_1 = require("./resources/stream.js");
const teams_1 = require("./resources/teams.js");
...
class SportsGameOdds {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('SPORTS_GAME_ODDS_BASE_URL'), apiKeyHeader = (0, env_1.readEnv)('SPORTS_ODDS_API_KEY_HEADER') ?? null, apiKeyParam = (0, env_1.readEnv)('SPORTS_ODDS_API_KEY_HEADER') ?? null, ...opts } = {}) {
        _SportsGameOdds_instances.add(this);
        _SportsGameOdds_encoder.set(this, void 0);
        this.events = new API.Events(this);
        this.teams = new API.Teams(this);
        this.players = new API.Players(this);
        this.leagues = new API.Leagues(this);
        this.sports = new API.Sports(this);
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('SPORTS_GAME_ODDS_LOG'), "process.env['SPORTS_GAME_ODDS_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _SportsGameOdds_encoder, Opts.FallbackEncoder, "f");
    ...
    async authHeaders(opts) {
        ...
        return (0, headers_1.buildHeaders)([{ 'x-api-key': this.apiKeyHeader }]);
    }
    /**
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.SportsGameOddsError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _SportsGameOdds_instances, "m", _SportsGameOdds_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _SportsGameOdds_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.SportsGameOdds = SportsGameOdds;
_a = SportsGameOdds, _SportsGameOdds_encoder = new WeakMap(), _SportsGameOdds_instances = new WeakSet(), _SportsGameOdds_baseURLOverridden = function _SportsGameOdds_baseURLOverridden() {
    return this.baseURL !== 'https://api.sportsgameodds.com/v2';
};
SportsGameOdds.SportsGameOdds = _a;
SportsGameOdds.DEFAULT_TIMEOUT = 60000; // 1 minute
SportsGameOdds.SportsGameOddsError = Errors.SportsGameOddsError;
SportsGameOdds.APIError = Errors.APIError;
SportsGameOdds.APIConnectionError = Errors.APIConnectionError;
SportsGameOdds.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
SportsGameOdds.APIUserAbortError = Errors.APIUserAbortError;
SportsGameOdds.NotFoundError = Errors.NotFoundError;
SportsGameOdds.ConflictError = Errors.ConflictError;
SportsGameOdds.RateLimitError = Errors.RateLimitError;
SportsGameOdds.BadRequestError = Errors.BadRequestError;
SportsGameOdds.AuthenticationError = Errors.AuthenticationError;
SportsGameOdds.InternalServerError = Errors.InternalServerError;
SportsGameOdds.PermissionDeniedError = Errors.PermissionDeniedError;
SportsGameOdds.UnprocessableEntityError = Errors.UnprocessableEntityError;
SportsGameOdds.toFile = Uploads.toFile;
SportsGameOdds.Events = events_1.Events;
SportsGameOdds.Teams = teams_1.Teams;
SportsGameOdds.Players = players_1.Players;
SportsGameOdds.Leagues = leagues_1.Leagues;
SportsGameOdds.Sports = sports_1.Sports;
SportsGameOdds.Stats = stats_1.Stats;
SportsGameOdds.Account = account_1.Account;
SportsGameOdds.Stream = stream_1.Stream;
