...
export declare class APIPromise<T> extends Promise<T> {
    ...
    constructor(client: SportsGameOdds, responsePromise: Promise<APIResponseProps>, parseResponse?: (client: SportsGameOdds, props: APIResponseProps) => PromiseOrValue<T>);
