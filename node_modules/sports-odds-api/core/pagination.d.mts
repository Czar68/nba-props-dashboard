...
export declare abstract class AbstractPage<Item> implements AsyncIterable<Item> {
    ...
    constructor(client: SportsGameOdds, response: Response, body: unknown, options: FinalRequestOptions);
...
export declare class PagePromise<PageClass extends AbstractPage<Item>, Item = ReturnType<PageClass['getPaginatedItems']>[number]> extends APIPromise<PageClass> implements AsyncIterable<Item> {
    constructor(client: SportsGameOdds, request: Promise<APIResponseProps>, Page: new (...args: ConstructorParameters<typeof AbstractPage>) => PageClass);
    /**
...
export declare class NextCursorPage<Item> extends AbstractPage<Item> implements NextCursorPageResponse<Item> {
    data: Array<Item>;
    nextCursor: string;
    constructor(client: SportsGameOdds, response: Response, body: NextCursorPageResponse<Item>, options: FinalRequestOptions);
