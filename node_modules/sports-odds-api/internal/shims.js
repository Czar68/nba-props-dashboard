...
function getDefaultFetch() {
    ...
    throw new Error('`fetch` is not defined as a global; Either pass `fetch` to the client, `new SportsGameOdds({ fetch })` or polyfill the global, `globalThis.fetch = fetch`');
}
